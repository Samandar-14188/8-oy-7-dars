...
export default function Products() {
  ...
  <nav className="navbar page">
    <div className="nav-center">
      ...
      {/* logo */}
      <img src="https://your-comfy-store.netlify.app/images/logo-black.svg" className="nav-logo" alt="logotip" />
      {/* cart icon */}
    ...
    <aside className="cart">
      ...
      <header>
        <h3 className="text-slanted">
          <font style={{ verticalAlign: "inherit" }}>
            <font style={{ verticalAlign: "inherit" }}>sizning sumkangiz</font>
          </font>
        </h3>
      </header>
      {/* cart items */}
    ...
    <div className="products-container">
      ...
      <article className="product">
        ...
        <footer>
          <p className="product-name">
            <font style={{ verticalAlign: "inherit" }}>
              <font style={{ verticalAlign: "inherit" }}>aksent kreslo</font>
            </font>
          </p>
          <h4 className="product-price">
            <font style={{ verticalAlign: "inherit" }}>
      ...
      <article className="product">
        ...
        <footer>
          <p className="product-name">
            <font style={{ verticalAlign: "inherit" }}>
              <font style={{ verticalAlign: "inherit" }}>divan to'plami</font>
            </font>
          </p>
          <h4 className="product-price">
            <font style={{ verticalAlign: "inherit" }}>
      ...
      <article className="product">
        ...
        <footer>
          <p className="product-name">
            <font style={{ verticalAlign: "inherit" }}>
              <font style={{ verticalAlign: "inherit" }}>utopiya divan</font>
            </font>
          </p>
          <h4 className="product-price">
            <font style={{ verticalAlign: "inherit" }}>
      ...
      <article className="product">
        ...
        <footer>
          <p className="product-name">
            <font style={{ verticalAlign: "inherit" }}>
              <font style={{ verticalAlign: "inherit" }}>albaniya bo'limi</font>
            </font>
          </p>
          <h4 className="product-price">
            <font style={{ verticalAlign: "inherit" }}>
